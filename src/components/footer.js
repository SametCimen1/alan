                                    ...
                                    <div class="w-full mt-3">
                                        ...
                                        {openQuestion.q1 &&
                                            <div class="mt-6 border-l-2 border-gray-50 pl-10">
                                                ...
                                                <p class="mb-2 text-lg">To search with Type of attraction: Type the name of the attraction you want. Full list can be found in the home page (click on the categories button)</p>
